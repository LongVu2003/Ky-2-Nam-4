 ...
 */
// Generated on: 18.06.2025 20:52:55
...
const TfArray<1, float> quant0_scale = { 1, { 4.313725471496582, } };
const TfArray<1, int> quant0_zero = { 1, { -128 } };
const TfLiteAffineQuantization quant0 = { (TfLiteFloatArray*)&quant0_scale, (TfLiteIntArray*)&quant0_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data1[5] = { 3, -4, 2, 4, 4, };
const TfArray<1, int> tensor_dimension1 = { 1, { 5 } };
const TfArray<1, float> quant1_scale = { 1, { 0.011334183625876904, } };
const TfArray<1, int> quant1_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant1 = { (TfLiteFloatArray*)&quant1_scale, (TfLiteIntArray*)&quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data2[5*10] = { 
  93, -23, -80, 58, -100, 10, 68, -101, 63, 28, 
  58, 107, 0, 2, -107, 110, -44, 52, 87, 52, 
  -106, -23, -44, -93, -98, 92, 127, 17, 50, 48, 
  11, 124, -118, 98, -46, -17, -36, -66, -15, -46, 
  76, -97, -107, 52, -110, 43, 83, -107, 6, 87, 
};
const TfArray<2, int> tensor_dimension2 = { 2, { 5,10 } };
const TfArray<1, float> quant2_scale = { 1, { 0.0049736937507987022, } };
const TfLiteAffineQuantization quant2 = { (TfLiteFloatArray*)&quant2_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data3[10] = { 10, 0, 0, 7, 7, -5, 5, -7, -6, -6, };
const TfArray<1, int> tensor_dimension3 = { 1, { 10 } };
const TfArray<1, float> quant3_scale = { 1, { 0.0067828772589564323, } };
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data4[10*20] = { 
  40, -64, -68, 13, 115, 31, 113, -93, 9, -51, 38, 33, 63, 114, 54, -62, 0, -12, -57, 40, 
  -56, -114, 68, 67, 54, -41, -52, -97, -93, 18, -52, -53, 63, 22, 70, 90, -50, 34, -44, -31, 
  -23, -97, -3, 105, -48, -59, -36, 21, -41, -11, 32, 51, -21, -86, -13, -70, 84, -97, -100, -81, 
  59, 25, 94, 3, -55, 88, -58, -33, -17, 73, 111, 60, -73, -94, -4, -29, -26, -42, 118, 94, 
  -45, 68, -96, -43, -75, 79, -36, 35, -83, 61, 99, 66, -20, 49, 25, -105, -49, 109, 81, 67, 
  -88, 60, -69, 51, -40, -127, -7, 67, -126, -47, 67, 50, -51, 63, -24, -68, -37, 52, -78, -4, 
  92, 55, -59, -78, 89, 87, 11, -25, -18, 3, 71, 49, -72, -41, 9, -3, 60, -10, -8, -26, 
  -15, 79, 47, 61, -23, 74, 87, -124, 102, -30, -71, 101, 66, -27, -100, 36, 86, -6, 1, 74, 
  62, 28, 55, 41, 75, 20, -109, -41, -42, 12, 81, 9, -5, -105, -34, 82, -87, 58, -61, -42, 
  44, -78, -16, -2, 72, 93, -20, 5, 70, -93, -67, 42, -75, -54, 56, -2, -18, 82, -3, 69, 
};
const TfArray<2, int> tensor_dimension4 = { 2, { 10,20 } };
const TfArray<1, float> quant4_scale = { 1, { 0.0038320189341902733, } };
const TfLiteAffineQuantization quant4 = { (TfLiteFloatArray*)&quant4_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data5[20] = { 0, -2, 0, 0, 0, 2, 0, 3, -3, 0, 3, -2, 0, 0, 0, -3, 0, -2, 3, -2, };
const TfArray<1, int> tensor_dimension5 = { 1, { 20 } };
const TfArray<1, float> quant5_scale = { 1, { 0.017930701375007629, } };
...
const TfArray<1, float> quant9_scale = { 1, { 0.66439515352249146, } };
const TfArray<1, int> quant9_zero = { 1, { 114 } };
...
TfLiteStatus tflite_learn_2_init( void*(*alloc_fnc)(size_t,size_t) ) {
...
TfLiteStatus tflite_learn_2_input(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(in_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_2_output(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(out_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_2_invoke() {
...
TfLiteStatus tflite_learn_2_reset( void (*free_fnc)(void* ptr) ) {
#ifdef EI_CLASSIFIER_ALLOCATION_HEAP
