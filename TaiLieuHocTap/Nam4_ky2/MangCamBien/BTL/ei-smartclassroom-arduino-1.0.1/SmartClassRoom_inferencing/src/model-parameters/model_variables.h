...
#include "tflite-model/tflite_learn_2_compiled.h"
#include "edge-impulse-sdk/classifier/ei_model_types.h"
#include "edge-impulse-sdk/classifier/inferencing_engines/engines.h"

const char* ei_classifier_inferencing_categories[] = { "can_bat_den", "can_bat_den_va_quat", "can_bat_quat", "dieu_kien_ly_tuong", "phong_trong" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_3_axes[] = { 0, 1, 2, 3 };
...
const ei_config_tflite_eon_graph_t ei_config_tflite_graph_2 = {
    .implementation_version = 1,
    .model_init = &tflite_learn_2_init,
    .model_invoke = &tflite_learn_2_invoke,
    .model_reset = &tflite_learn_2_reset,
    .model_input = &tflite_learn_2_input,
    .model_output = &tflite_learn_2_output,
};

ei_learning_block_config_tflite_graph_t ei_learning_block_config_2 = {
    .implementation_version = 1,
...
const ei_impulse_t impulse_724533_0 = {
    .project_id = 724533,
    .project_owner = "longvu2003",
    .project_name = "SmartClassRoom",
    .impulse_id = 1,
    ...
    .fusion_string = "temperature + humidity + light_intensity + motion",
    .slice_size = (1/4),
...
ei_impulse_handle_t impulse_handle_724533_0 = ei_impulse_handle_t( &impulse_724533_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_724533_0;
